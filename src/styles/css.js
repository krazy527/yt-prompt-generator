...
.bg-word{position:absolute;z-index:2;left:50%;top:30%;transform:translate(-50%,-50%);font-family:'Bebas Neue',sans-serif;font-size:clamp(30px,10vw,80px);letter-spacing:8px;opacity:.08;pointer-events:none;text-align:center;white-space:nowrap;}
